...
<div class="bubble">
<div class="rectangleResult"><h2>Kolej IbnuSina Floor 2</h2></div>
...
<table align="center">
	<tr>
		<td>FLOOR</td>
		<td><a href="floor1KI.php?Number=<?php echo $rec['stuNum'];?>"/><img src="images/1.png" /></td>
		<td><a href="floor2KI.php?Number=<?php echo $rec['stuNum'];?>"/><img src="images/2.png" /></td>
		<td><a href="floor3KI.php?Number=<?php echo $rec['stuNum'];?>"/><img src="images/3.png" /></td>
		<td><a href="floor4KI.php?Number=<?php echo $rec['stuNum'];?>"/><img src="images/4.png" /></td>
		<td><a href="floor5KI.php?Number=<?php echo $rec['stuNum'];?>"/><img src="images/5.png" /></td>
	</tr>
</table>
