...
$Ibnusina = mysql_query("SELECT * FROM permohonan WHERE status='Rejected' and stuGender='MALE'" );
$Albiruni = mysql_query("SELECT * FROM permohonan WHERE status='Rejected' and stuGender='FEMALE'" );
$Ibnusina1 = mysql_query("SELECT * FROM rayuan WHERE status='Rejected' and stuGender='MALE'" );
$Albiruni1 = mysql_query("SELECT * FROM rayuan WHERE status='Rejected' and stuGender='FEMALE'" );

$listIbnusina = mysql_query("SELECT * FROM permohonan WHERE status='Rejected' and stuGender='MALE'" );
$listAlbiruni = mysql_query("SELECT * FROM permohonan WHERE status='Rejected' and stuGender='FEMALE'" );
$listIbnusina1 = mysql_query("SELECT * FROM rayuan WHERE status='Rejected' and stuGender='MALE'" );
$listAlbiruni1 = mysql_query("SELECT * FROM rayuan WHERE status='Rejected' and stuGender='FEMALE'" );
	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="#" class="active"><span>Rejected</span></a></li>
			</ul>
		</div>
		<!-- End Main Nav -->
	</div>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<?php echo "<h2 class=left>IbnuSina Rejected (" . $totalApprovedM . ")</h2>"; ?>
					</div>
					<!-- End Box Head -->	
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<?php echo "<h2 class=left>Albiruni Rejected (" . $totalApprovedF . ")</h2>"; ?>
					</div>
					<!-- End Box Head -->	
