...
<div class="info">
<form class="email" action="mailerUser.php" method="post">
<!--<p>Name:</p>
...
<table>
		<tr>
			<td>Name</td>
			<td>:</td>
			<td><input name="name" type="text" value="<?php echo $rec['name'];?>" size="45" required></td>
		<tr>
        
		<tr>
			<td>Email</td>
			<td>:</td>
			<td><input name="email" type="text" value="<?php echo $rec['email'];?>" size="45" required></td>
		<tr>
        <tr>
			<td>Subject</td>
			<td>:</td>
		...
		<tr>
			<td>To College</td>
			<td>:</td>
			<td><input type="radio" name="kolej" value="ibnusina@gmail.com" checked>IbnuSina<input type="radio" name="kolej" value="albiruni@gmail.com">Albiruni
		</tr>
		<tr>
			<td>Message</td>
			<td>:</td>
			<td><textarea rows = "10" cols = "50 " textarea name="message"></textarea></td>
		<tr>
