...
<div class="bubble">
<div class="rectangleResult"><h2>Kolej Albiruni Floor 1</h2></div>
...
<table border=1>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA101'"); 
$num_rows = mysql_num_rows($count); 
					...
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA101" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 101</span></a>
					<?php } ?>	</td>	
		<td>B</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA102'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA102" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 102</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA103'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA103" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 103</span></a>
					<?php } ?>	</td>		
		<td>L</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA104'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA104" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 104</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA105'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA105" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 105</span></a>
					<?php } ?>	</td>	
		<td>O</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA106'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA106" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 106</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA107'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA107" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 107</span></a>
					<?php } ?>	</td>	
		<td>C</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA108'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA108" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 108</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA109'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA109" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 109</span></a>
					<?php } ?>	</td>		
		<td>K</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA110'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA110" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 110</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA111'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA111" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 111</span></a>
					<?php } ?>	</td>	
		<td></td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA112'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA112" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 112</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA113'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA113" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 113</span></a>
					<?php } ?>	</td>		
		<td>A</td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA114'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA114" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 114</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA115'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA115" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA115</span></a>
					<?php } ?>	</td>		
		<td></td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA116'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA116" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 116</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA117'"); 
$num_rows = mysql_num_rows($count); 
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA117" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 117</span></a>
					<?php } ?>	</td>	
		<td></td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA118'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA118" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 118</span></a>
					<?php } ?>	</td>	
	</tr>
	<tr>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA119'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA119" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 119</span></a>
					<?php } ?>	</td>		
		<td></td>
		<td><?php $count = mysql_query("SELECT * FROM permohonan WHERE roomNum='KA120'"); 
$num_rows = mysql_num_rows($count);  
					echo $$num_rows;
					if($$num_rows==6)
					{ echo FULL; }
						...
						?>
					<a class="glidebutton" href="roomProcess.php?Number=<?php print($rec['stuNum']);?>&noBilik=KA120" onclick="return confirm('Are you sure to choose this room?');"><span data-text=" <?php echo $num_rows ,"/6";?> ">KA 120</span></a>
					<?php } ?>	</td>	
	</tr>
