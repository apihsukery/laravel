...
$list = mysql_query("SELECT * FROM permohonan WHERE status='In Progress' and stuGender='MALE'" );
$list1 = mysql_query("SELECT * FROM rayuan WHERE status='In Progress' and stuGender='MALE'" );
$count = mysql_query("SELECT * FROM permohonan WHERE status='In Progress' and stuGender='MALE'" );
$count1 = mysql_query("SELECT * FROM rayuan WHERE status='In Progress' and stuGender='MALE'" );
$approved = mysql_query("SELECT * FROM permohonan WHERE status='Approved' and stuGender='MALE'" );
$approved1 = mysql_query("SELECT * FROM rayuan WHERE status='Approved' and stuGender='MALE'" );
$countApproved=0;
$countApproved1=0;
$totalApproved=0;
$countApply=0;
	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="#" class="active"><span>Kolej IbnuSina</span></a></li>
			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="box-head">
						...
						<div class="right">
						<?php echo "<label>Total Approved " . $totalApproved . " /2700</label>"; ?>
						</div>
					</div>
					<!-- End Box Head -->	
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sortable">
							...
							<?php
								...
								<tr>
									...
									<td><a href="studentInfo.php?stuNum=<?php print ($row['stuNum']);?>&id=<?php echo $rec['stuNum'];?>" target="_blank" /><img src="images/info_button.png" height="30" width="30" alt="Info" />   <a href="studentAR.php?stuNum=<?php print ($row['stuNum']);?>&id=<?php echo $rec['stuNum'];?>&code=1&ar=1" /><img src="images/button_ok.png" height="30" width="30" alt="Approve" />   <a href="studentAR.php?stuNum=<?php print ($row['stuNum']);?>&id=<?php echo $rec['stuNum'];?>&code=1&ar=2" /><img src="images/button_cancel.png" height="30" width="30" alt="Reject" /></td>
								</tr>
