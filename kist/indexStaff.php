...
$count = 0;
$count1 = 0;
while(mysql_fetch_array($listCount,MYSQL_BOTH))
{
	$count = $count + 1;
}
		...
		<div id="main">
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2>Delete all record college</h2>
					</div>
					<!-- End Box Head-->
					
					<center><a href="deleteRec.php?id=<?php echo $rec['stuNum'];?>" onclick="return confirm('Are you sure to delete all data?');" /><img src="staff/images/delete.gif" width="128" height="128"/></center>
				</div>
